function doGet(e) {
  ...
  function updateFeedbackBibaHomu(feedback){
    ...
    if(feedback.handanResult == '承認します'){
      ...
      createUpdateUrl = `https://script.google.com/macros/s/AKfycbyJ2YK08Zq5JpRFnTIFfTDGGrQzDL3KxJmtwnXYfpPhZ6DSskAAddt9qXW1DiWbXAQ0/exec?formId=${addId}`;
    }
    ...
    let holdDate = bibaHomuSheet1.getRange('B' + rowToUpdate).getValue();
    htmlTemplate.konyuHidzuke = formatDate(holdDate);
