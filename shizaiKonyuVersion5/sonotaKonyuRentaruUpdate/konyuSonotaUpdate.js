function doGet(e) {
  ...
  function fetchDataFromSpreadsheet(formId){ 
    ...
    let holdIdsList = sonotaSheet1.getRange('P1:P' + sonotaSheet1LastRow).getValues();
    var rowToUpdate;
    ...
    if(checkUpdatedOrNot == '承認します'){
      ...
      const rowData = sonotaSheet1.getRange(rowToUpdate,1,1,sonotaSheet1.getLastColumn()).getValues()[0];
      return rowData;
    }
  }
  ...
  function acceptSonotaData(formData){
    ...
    let sonotaSheet1FinalLastRow = sonotaSheet1Final.getLastRow();
    ...
    var oldResponseEmail = sonotaSheet1.getRange('K' + rowToUpdate).getValue();
    ...
    sonotaSheet1.getRange('K' + rowToUpdate).setValue(oldResponseEmail);
    ...
    sonotaSheet1Final.getRange('K' + rowToUpdateFinal).setValue(oldResponseEmail);
    ...
    if(formData.tenpuFileSonota1 == '' && formData.oldTenpuFile1 == ''){
      ...
      Logger.log('second section');
    } else if(formData.tenpuFileSonota1 != '' && formData.oldTenpuFile1 == ''){
      Logger.log('third section');
      if(getOldFileUrlL != ''){
         deleteFileByUrl(getOldFileUrlL);
      }
      sonotaSheet1.getRange('L' + rowToUpdate).setValue(formData.tenpuFileSonota1);
      ...
      sonotaSheet1.getRange('L' + rowToUpdate).setValue(formData.oldTenpuFile1);
      //for final sheet 
      sonotaSheet1Final.getRange('L' + rowToUpdateFinal).setValue(formData.oldTenpuFile1);
    }
    ...
    if(formData.tenpuFileSonota2 == '' && formData.oldTenpuFile2 == ''){
      ...
      sonotaSheet1.getRange('M' + rowToUpdate).setValue(formData.oldTenpuFile2);
      //for final sheet 
      sonotaSheet1Final.getRange('M' + rowToUpdateFinal).setValue(formData.oldTenpuFile2);
    }
    ...
    if(formData.tenpuFileSonota3 == '' && formData.oldTenpuFile3 == ''){
      ...
      sonotaSheet1.getRange('N' + rowToUpdate).setValue(formData.oldTenpuFile3);
      //for final sheet 
      sonotaSheet1Final.getRange('N' + rowToUpdateFinal).setValue(formData.oldTenpuFile3);
    }
